...
public class CompassView extends View{
    ...
    public CompassView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        mDarkRedPaint.setColor(context.getResources().getColor(R.color.cyan)); // 青色 外圈笔


        mDeepGrayPaint = new Paint();
        mDeepGrayPaint.setStyle(Paint.Style.STROKE);
        mDeepGrayPaint.setAntiAlias(true);
        mDeepGrayPaint.setColor(context.getResources().getColor(R.color.deepGray));  // 深灰  外三角


        mLightGrayPaint = new Paint();
        mLightGrayPaint.setStyle(Paint.Style.FILL);
        mLightGrayPaint.setAntiAlias(true);
        mLightGrayPaint.setColor(context.getResources().getColor(R.color.lightGray));  //浅灰  外圈笔

        mTextPaint = new Paint();
        mTextPaint.setStyle(Paint.Style.STROKE);
        mTextPaint.setAntiAlias(true);
        mTextPaint.setTextSize(80);
        mTextPaint.setColor(context.getResources().getColor(R.color.cyan));   //   指南针上面 文字笔

        mCircumPaint = new Paint();
        mCircumPaint.setStyle(Paint.Style.FILL);
        mCircumPaint.setAntiAlias(true);
        mCircumPaint.setColor(context.getResources().getColor(R.color.cyan));  //  指南针上面文字的外接矩形,用来测文字大小让文字居中

        mOutSideCircumPaint = new Paint();
        mOutSideCircumPaint.setStyle(Paint.Style.FILL);
        mOutSideCircumPaint.setAntiAlias(true);
        mOutSideCircumPaint.setColor(context.getResources().getColor(R.color.lightGray));   //外三角笔
        ...
        mNorthPaint.setColor(context.getResources().getColor(R.color.cyan));   //NESW 文字笔 和文字外接矩形

        mOthersPaint = new Paint();
        mOthersPaint.setStyle(Paint.Style.STROKE);
        mOthersPaint.setAntiAlias(true);
        mOthersPaint.setTextSize(40);
        mOthersPaint.setColor(context.getResources().getColor(R.color.orange));   //NESW 文字笔 和文字外接矩形
        ...
        mCenterPaint.setColor(context.getResources().getColor(R.color.orange));   //中心文字笔
        ...
        mSamllDegreePaint.setColor(context.getResources().getColor(R.color.lightGray));   //小刻度文字大小矩形和画笔
        ...
        mAnglePaint.setColor(context.getResources().getColor(R.color.cyan));  //偏转角度红线笔
